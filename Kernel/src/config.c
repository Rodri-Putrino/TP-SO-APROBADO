...
void procesar_archivo_config_kernel(t_config* config_consola) {
    ...
    puerto_cpu_dispatch = config_get_int_value(config_consola, "PUERTO_CPU_DISPATCH");
    puerto_cpu_interrupt = config_get_int_value(config_consola, "PUERTO_CPU_INTERRUPT");
