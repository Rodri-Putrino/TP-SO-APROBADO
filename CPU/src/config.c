...
void procesar_archivo_config_cpu(t_config* config_consola) {
    ...
    puerto_memoria = config_get_int_value(config_consola, "PUERTO_MEMORIA");
    puerto_escucha_dispatch = config_get_int_value(config_consola, "PUERTO_ESCUCHA_DISPATCH");
    puerto_escucha_interrupt = config_get_int_value(config_consola, "PUERTO_ESCUCHA_INTERRUPT");
}